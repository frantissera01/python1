...
def modificar_carrito():
    ...
    if codigo in carrito:
        ...
        if nueva_cantidad > 0:
            ...
            producto["Costo_total"] = producto["Precio_unitario"] * nueva_cantidad
